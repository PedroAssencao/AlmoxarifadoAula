...
namespace ApiAlmoxarifao.Api.Migrations
{
    ...
    [Migration("20240309002926_MAisATUALIZADA")]
    partial class MAisATUALIZADA
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiAlmoxarifao.Api.Models.ItemRequisicao", b =>
                {
                    ...
                    b.Property<decimal?>("ItemPreco")
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("item_preco");
            ...
            modelBuilder.Entity("ApiAlmoxarifao.Api.Models.ItemRequisicao", b =>
                {
                    b.HasOne("ApiAlmoxarifao.Api.Models.Produto", "Pro")
                        .WithMany("ItemRequisicaos")
                        .HasForeignKey("ProId")
                        .HasConstraintName("FK__ItemRequi__pro_i__0C85DE4D");

                    b.HasOne("ApiAlmoxarifao.Api.Models.Requisicao", "Req")
                        .WithMany("ItemRequisicaos")
                        .HasForeignKey("ReqId")
